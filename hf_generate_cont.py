...
def main(args: Namespace) -> None:
    ...
    try:
        if args.name_or_path == "fastchat-t5-3b-v1.0" or args.name_or_path == "lmsys/fastchat-t5-3b-v1.0":
            model = T5ForConditionalGeneration.from_pretrained(args.name_or_path,
                                                     config=config,
    ...
    if args.name_or_path == "fastchat-t5-3b-v1.0" or args.name_or_path == "lmsys/fastchat-t5-3b-v1.0":
        tokenizer = T5Tokenizer.from_pretrained(args.name_or_path,
                                              **from_pretrained_kwargs)
    else:
