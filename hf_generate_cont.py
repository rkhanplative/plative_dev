...
import torch
from transformers import AutoConfig, AutoModelForCausalLM, AutoTokenizer, AutoModelForConditionalGeneration
...
def main(args: Namespace) -> None:
    ...
    try:
        if args.name_or_path == "fastchat-t5-3b-v1.0":
            model = AutoModelForConditionalGeneration.from_pretrained(args.name_or_path,
                                                     config=config,
